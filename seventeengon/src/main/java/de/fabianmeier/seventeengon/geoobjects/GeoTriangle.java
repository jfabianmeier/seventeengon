...
public class GeoTriangle extends GeoDrawingObject
{
	...
	{
		canvas.drawLine(a.getXY(), b.getXY(), getDrawingStrength(), label);
		canvas.drawLine(b.getXY(), c.getXY(), getDrawingStrength(), null);
		canvas.drawLine(c.getXY(), a.getXY(), getDrawingStrength(), null);
	}
